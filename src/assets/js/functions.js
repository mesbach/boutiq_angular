...
function init_menu_reposive() {
    ...
    console.log("function js: is mobile: ", kt_is_mobile);
        ...
        $(document).on('click', '.boutique-nav .menu-item-has-children > a', function (e) {
            ...
            if (!licurrent.hasClass('show-submenu')) {
                ...
                if ($.trim(href) == '' || $.trim(href) == '#') {
                    ...
                    console.log("menu item clicked, redirect to", href);
                }
            }
            // Close all child submenu if parent submenu is closed
            if (!licurrent.hasClass('show-submenu')) {
...
$(document).ready(function () {
    ...
    init_carousel();
    //MENU REPONSIIVE
    // setTimeout(function(){init_menu_reposive();}, 1000);
    init_menu_reposive();
    //SELECT CHOSEN
    // $("select").chosen();
    // Resize Megamenu
...
$(document).ready(function () {
    ...
    $("#main-root").show();
    setTimeout(function () {
        $(".mCustomScrollbar").css({ width: "calc(100vw - 20px)" });
    }, 1000);
});